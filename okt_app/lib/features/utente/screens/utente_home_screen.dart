...
class UtenteHomeScreen extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/utente/notifications'),
          ),
        ],
      ),
      body: Padding(
            ...
            GridView.count(
              ...
              children: [
                HomeActionCard(
                  ...
                  onTap: () => context.push('/utente/reports'),
                ),
                HomeActionCard(
                  label: 'Novo Teste',
                  icon: Icons.note_add_outlined,
                  color: AppColors.lightGreen,
                  onTap: () => context.push('/utente/new-test'),
                ),
                HomeActionCard(
                  label: 'Perfil',
                  icon: Icons.person_outline,
                  color: AppColors.lightOrange,
                  onTap: () => context.push('/utente/profile'),
                ),
                HomeActionCard(
                  label: 'SOS',
