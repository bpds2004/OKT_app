...
export default function UnidadeTesteRealizadoPage() {
  return (
    <PageTransition>
      <MobileShell title="Teste Realizado" icon={<CheckCircle2 className="h-5 w-5" />} backHref="/unidade/pagina-principal">
        ...
        <Card className="mt-6 p-4 text-sm text-brand-600">
          ...
          <div className="mt-4 space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-brand-800">João Pedro Gomes</span>
            </div>
          </div>
        </Card>
