...
export default function UnidadeNovoTestePage() {
  return (
    <PageTransition>
      <MobileShell title="Novo teste" icon={<ClipboardCheck className="h-5 w-5" />} backHref="/unidade/pagina-principal">
        <div className="space-y-4">
          ...
          <div>
            <label className="text-sm font-semibold text-brand-700">Nome do Paciente</label>
            <Input placeholder="Ex: João Pedro Gomes" className="mt-2" />
          </div>
