...
const notifications = [
  { id: "Zx78T", time: "Há 5 minutos" },
  { id: "ZW59C", time: "Há 10 horas" },
  { id: "HG76C2", time: "Há 35 dias" },
];
...
export default function NotificacoesPage() {
  ...
  return (
    <PageTransition>
      <MobileShell title="Notificações" icon={<Bell className="h-5 w-5" />} backHref="/utente/pagina-principal">
            ...
            <Card key={item.id} className="relative p-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Badge variant="negative" className="mt-2">
                    Negativo
                  </Badge>
                  <Link href="/utente/resultado-teste" className="mt-2 inline-block text-xs font-semibold text-brand-600">
                    Ver relatório
                  </Link>
                </div>
              </div>
