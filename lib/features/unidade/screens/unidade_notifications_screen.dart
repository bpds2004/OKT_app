...
final unidadeNotificationsProvider = FutureProvider((ref) async {
...
class UnidadeNotificationsScreen extends ConsumerWidget {
  const UnidadeNotificationsScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final notifications = ref.watch(unidadeNotificationsProvider);
