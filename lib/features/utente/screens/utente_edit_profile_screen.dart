...
final utenteEditProfileProvider = FutureProvider((ref) async {
...
class UtenteEditProfileScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UtenteEditProfileScreen> createState() => _UtenteEditProfileScreenState();
}

class _UtenteEditProfileScreenState extends ConsumerState<UtenteEditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    final profileAsync = ref.watch(utenteEditProfileProvider);
